        ...
        <div>
            <div className="flex max-lg:flex-col *:flex *:gap-3 *:mt-3">
                ...
                <div className="max-lg:mt-0">
                    ...
                    {props.letra[1] ? <ButtonSimplificar letra={props.letra} setLetra={setLetra} setLetraComCapo={setLetraComCapo} acordes={props.acordes} setAcordes={setAcordes} tipo={tipoCifra} setTipo={setTipoCifra}/> : null}
                </div>
            </div>
